...
// network.
static const u1_t PROGMEM DEVEUI[8]= {0x46, 0x95, 0x06, 0xD0, 0x7E, 0xD5, 0xB3, 0x70};
void os_getDevEui (u1_t* buf) { memcpy_P(buf, DEVEUI, 8);}

// LoRaWAN end-device address (DevAddr)
static const u1_t PROGMEM APPKEY[16] = {0x08, 0xE7, 0x92, 0x07, 0x3C, 0xF6, 0x55, 0xB0, 0x9F, 0x49, 0x55, 0x0F, 0x09, 0x9F, 0x89, 0x07};
